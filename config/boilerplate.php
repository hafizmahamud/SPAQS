    ...
    */
    'access' => [
        'captcha' => [
            ...
            'saringan_wajib' => env('SARINGAN_WAJIB_CAPTCHA_STATUS', false),
            'hadir_tapak' => env('HADIR_TAPAK_CAPTCHA_STATUS', false),
        ],
        ...
        'iklan' => [
            /*
             * Whether or not a jenis iklan can be permanently deleted from the system via the backend
             *
             *
             */
            'permanently_delete' => false,
