...
class CreatePenilaianPerolehanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penilaian_perolehan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('penilaian_perolehan');
    }
}
