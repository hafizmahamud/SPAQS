...
class LaporanBIklan extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Jumlah Jadual Harga')
        ];
    }
    ...
    public function export()
    {
        ...
        $query = IklanPerolehan::where('status_iklan_id','>=',2)
                    ->where('status_iklan_id','<',7)
                    ->with(
                        'user',
                        'mohonNoPerolehan',
        ...
        $callback = function() use($query, $columns) {
            ...
            foreach ($query as $query2) {
                ...
                $row['Jadual Harga']  = $query2->jadualHarga->count();
    ...
    public function exportPDF()
    {
        ...
        $detail = IklanPerolehan::where('status_iklan_id','>=',2)
                    ->where('status_iklan_id','<',7)
                    ->with(
                        'user',
                        'mohonNoPerolehan',
