...
<td><a class="btn btn-outline-primary-rounded-pill-list" href="{{ route('iklanTelahTutup.jadualharga', $row->id) }}" role="button" style="margin-bottom:10px">
    {{$row->mohonNoPerolehan['no_perolehan']}}</a><br>
    {{$row->mohonNoPerolehan['tajuk_perolehan']}}
</td>
@elseif($row->jadual_harga_status == 'DRAF')
<td><a class="btn btn-secondary-rounded-pill-list" href="{{ route('iklanTelahTutup.jadualharga', $row->id) }}" role="button" style="margin-bottom:10px">
    {{$row->mohonNoPerolehan['no_perolehan']}}</a><br>
    {{$row->mohonNoPerolehan['tajuk_perolehan']}}
</td>
@elseif($row->jadual_harga_status == 'SELESAI')
<td><a class="btn btn-primary-rounded-pill-list" href="{{ route('iklanTelahTutup.jadualharga', $row->id) }}" role="button" style="margin-bottom:10px">
    {{$row->mohonNoPerolehan['no_perolehan']}}</a><br>
    {{$row->mohonNoPerolehan['tajuk_perolehan']}}
</td>
@endif
