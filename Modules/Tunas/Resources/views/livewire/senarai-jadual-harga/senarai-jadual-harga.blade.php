                ...
                <table class="table table-striped" id="example" style="width: 100%;">
                    <thead style="display: table; width: 100%; table-layout: fixed;">
                        <tr>
                            ...
                            <th style="width: 200px;color: black; font-size:12px" class="text-center">Harga (RM)
                    ...
                    <tbody id="myTable" style="display: block; overflow-y: auto; table-layout: fixed;  max-height: 200px;">
                        @if( $jadualHarga->isEmpty())
                            <tr id='tiada' style="display: table; width: 100%; table-layout: fixed;">
                                <td colspan="12" class="text-center" style="font-size:12px">Data Sedang Diproses</td>
                            </tr>
                        @else
