...
<div class="pagetitle">
    <h1>Kemaskini Permohonan Baharu</h1>
...
<form id="myForm" autocomplete="off" method="post" action="{{ url('/tunas/saveiklan') }}" enctype="multipart/form-data"
    style="padding: 10px;">
    @csrf
    <section class="section">
        {{-- <ul style="width: 30%; background: white;" class="nav nav-tabs d-flex" id="myTabjustified" role="tablist" >
            ...
            <li class="nav-item flex-fill" role="presentation" style="width: 50%;">
                <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">Borang Saringan Wajib</button>
            </li>
        </ul> --}}
        <div class="tab-content pt-2" id="myTabjustifiedContent">
            <div class="tab-pane fade show active" id="home-justified" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="card">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <label class=" form-label" style="font-weight: bold;">Tajuk Projek<a style="color: red;"> *</a></label>
                            <div>
                                <textarea class="form-control" name="tajuk" id="tajuk" style="height: 100px" onkeyup="
                                var start = this.selectionStart;
                                var end = this.selectionEnd;
                                this.value = this.value.toUpperCase();
                                this.setSelectionRange(start, end);" required>{{ $mohon->tajuk_perolehan }} </textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div>
                                <select class="form-select" name="bayar_kepada" id="bayar_kepada" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <i class="bi bi-info-circle-fill"></i>
                            <span class="tooltip-text" style="font-weight: bold; margin-right:300px; margin-top:10px;">
                        ...
                        <div class="col-lg-6">
                            <label class="form-label" style="font-weight: bold;">Muat Naik Dokumen Tender</label>
                            <i class="bi bi-info-circle-fill"></i>
                            ...
                            <div>
                                <div class="col-lg-4">
                                    <input for="upload" type="button" class="btn btn-outline-primary"
                                        value="Muat Naik" onclick="document.getElementById('fileTender').click();"
                                        style="width: 100%;" />
                                    <input type="file" id="fileTender" name="fileTender" onchange="handleFileSelectTender(event)"
                                        style="display:none;" accept=".zip"><br><br>
                                </div>
                                <div class="col-lg-12">
                                    <div id="selectedFilesTender" name="selectedFilesTender"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div id="file_tender">
                                ...
                                <div class="ml-5">
                                    ...
                                    <i class="mdi mdi-minus-circle" style="color: red; font-size:24px;"
                                        onclick="deletetender({{ $dt->id }}, {{ $dt->iklan_perolehan_id }})"
                                        data-id="{{ $dt->id }}"></i>
                                </div>
                                @endforeach
                                @endif
      ...
      <div class="button-form">
        @if ($data->status_iklan_id == 4)
            <button class="btn btn-primary" id="hantar" name="hantar" type="submit" value="hantar" style="width: 10%; display:none;">Iklan</button>
            <button class="btn btn-success" id="kemaskini" name="kemaskini" type="submit" value="kemaskini" style="width: 10%;">Kemaskini</button>
        ...
        @else
            ...
            @if($butangBatal == '1')
                <input disabled='disabled' class="btn btn-outline-danger" style="width: 10%; margin-right: 10px; " type="submit" id="Batal" name="Batal" value="Batal" formnovalidate>
            @else
                <input class="btn btn-outline-danger" style="width: 10%; margin-right: 10px;" type="submit" id="Batal" name="Batal" value="Batal" formnovalidate>
            @endif
        @endif
        ...
        <input type="checkbox" id="bahagian_PUKONSA" name="bahagian_PUKONSA" style="display:none;">
        <input type="checkbox" id="bahagian_UPKJ" name="bahagian_UPKJ" style="display:none;">
    </div>
    </section>
</form>
...
<script>
    ...
    function success() {
        ...
        var count = 0;
        var peti_tender = document.getElementById("peti_tender").value;
    ...
    // delete uploaded file tender
    function deletetender(id, iklan_id) {
        Swal.fire({
            title: "Adakah Anda Pasti Untuk Hapuskan Fail Ini ?",
            showCancelButton: true,
            confirmButtonText: 'Ya',
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        let tender = document.getElementById('file_tender');
                        tender.innerHTML = '';
                        response.forEach(element => {
                            tender.innerHTML += `
                                ...
                                .nama +
                                `</a>
                                <i class="mdi mdi-minus-circle" style="color: red; font-size:24px;" onclick="deletetender(` +
    ...
    function handleFileSelectIklan(e) {
        ...
        if (saiz > 10) {
            ...
            console.log(document.getElementById('selectedFilesIklan'));
    ...
    function handleFileSelectTender(e) {
        if (!e.target.files) return;
        ...
        if (saiz > 10) {
            ...
            var fileTender = document.getElementById("fileTender");
            var newInputfileTender = document.createElement("input");
            newInputfileTender.type = "file";
            newInputfileTender.id = fileTender.id;
            newInputfileTender.name = fileTender.name;
            newInputfileTender.className = fileTender.className;
            newInputfileTender.accept = fileTender.accept;
            newInputfileTender.onchange = fileTender.onchange;
            newInputfileTender.style.cssText = fileTender.style.cssText;
            fileTender.parentNode.replaceChild(newInputfileTender, fileTender);
        } else {
            var ul = document.createElement('ul');
            var files = e.target.files;
            for (var i = 0; i < files.length; i++) {
    ...
    $( "form" ).submit(function( event ) {
        ...
        } else if(document.activeElement.value == 'kemaskini'){
            Swal.fire({
                ...
                if (result.isConfirmed == true) {
                    document.getElementById("status").value = 'kemaskini';
                    $("#wait").css("display", "block");
                    $("div.spanner").addClass("show");
                    document.getElementById("myForm").submit();
                } else {
    ...
    function carabayar(e){
        if (e.target.value == '1'){
            ...
            document.getElementById('bayar_kepada').value = 'Sila Pilih';
    ...
    $(document).ready(
        ...
        function () {
            //for cara bayar
            if (document.getElementById('cara_bayar').value == '1'){
                document.getElementById('harga_dokumen').readOnly = true;
                document.getElementById('bayar_kepada').disabled = true;
                document.getElementById('bayar_kepada').value = 'Sila Pilih';
                ...
                $.getScript("{{ Module::asset('sisdant:js/select2.min.js') }}",
                    function () {
                        ...
                        if(pukonsa_data.length > 0){
                            //start pukonsa
                            document.getElementById("bahagian_PUKONSA").checked = true;
                        ...
                        if(upkj_data.length > 0){
                            document.getElementById("bahagian_UPKJ").checked = true;
