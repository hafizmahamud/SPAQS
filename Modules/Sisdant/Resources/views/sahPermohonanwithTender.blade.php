...
@section('content')
        ...
        <section class="section" style="margin-bottom: 50px;">
          <div class="card">
                    ...
                    <div class="row mb-3">
                      <div class="col-lg-6">
                        ...
                        <div style="padding-top: 15px;">
                          ...
                          <div>
                              <select class="form-select" name="tender" id="tender" >
                              <option value="" >Sila Pilih</option>
                              </select>
                          </div>
                        </div>
            ...
            <div class="button-form">
              ...
              <button class="btn btn-outline-danger" id="batal" name="simpan" type="submit" value="batal"  style="width: 10%;">Batal</button>
              ...
              <input class="form-control" type="text" id="id_perolehan" name="id_perolehan" style="display:none;">
               {{-- <input class="form-control" type="text" name="running_no" value={{$run_number}} style="display:none;"> --}}
              ...
              {{-- <input class="form-control" type="text" id="no_perolehan" name="no_perolehan" value={{$no_perolehan}} style="display:none;"> --}}
            </div>
        </section>
      </form>
      ...
      <script>
        ...
        function function_noperolehan() {
          ...
          var jenis_iklan_id = document.getElementById("jenis_iklan").value;
          var kategori_perolehan_id = document.getElementById("perolehan").value;
          $.ajax({
              url: '/sisdant/getnoperolehan',
              headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              },
              data: {'section_id': section_id, 'jenis_iklan_id': jenis_iklan_id, 'kategori_perolehan_id': kategori_perolehan_id, 'negeri_id': negeri_id, 'tahun_perolehan': tahun_p},
              type: 'post',
              dataType: 'json',
              success: function(response){
                document.getElementById("noperolehan").value = response[0];
        ...
        $('#perolehan').change(function(){
          ...
          var jenis_iklan_id = document.getElementById("jenis_iklan").value;
          var kategori_perolehan_id = document.getElementById("perolehan").value;
          var tahun_perolehan = document.getElementById("tahun").value;
          ...
          $.ajax({
            ...
            data: {'jenisperolehan': kategori_perolehan_id, 'jenisiklan': jenis_iklan_id,'negeri': negeri, 'section':section, 'tahun':tahun_perolehan},
            type: 'post',
            dataType: 'json',
