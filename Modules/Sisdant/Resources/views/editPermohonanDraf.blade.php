    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <label class="form-label">Muat Naik</label><a id="style_muat_naik" style="color: red;"
                            hidden>*</a>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <input for="upload" type="button" class="btn btn-outline-primary" value="Dokumen Iklan"
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <input type="date" name="tarikh_iklan" id="datePicker" class="form-control" style="width:660px;" required>
...
<script>
    ...
    $(document).ready(function () {
        ...
        if (data.dokumen_muatnaik) {
            ...
            li.innerHTML = data.nama_dokumen;
            ul.appendChild(li);
