...
<div class="pagetitle">
    ...
    <section class="section">
        ...
        <ul style="width: 15%; background: white;" class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                    ...
                    <div class="tab-pane fade show active" id="profile-justified" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div>
                                    <input class="form-control" type="text" id="bil_mesyuarat" name="bil_mesyuarat" style="width: 50%;" onchange="success_keputusan()" placeholder="01/2021" >
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row mb-3">
                                    <input type="number" class="form-control" id="no_rujukan_ep" name="no_rujukan_ep" min="1" onclick="success_keputusan()"  style="width:10%; margin-left:10px; margin-right:5px;">
                                    ...
                                    <input type="number" class="form-control" id="no_rujukan_ep1" name="no_rujukan_ep1" min="1" onclick="success_keputusan()" style="width:10%;" required>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
...
<script>
    ...
    function success_keputusan() {
        ...
        if(tarikh_laporan && tarikh_mesyuarat && tarikh_keputusan && tarikh_terima && tarikh_edar && no_rujukan_ep && no_rujukan_ep1 && bil_mesyuarat && keputusan && harga && tempoh && bulan_minggu && alamat && alamat2 && alamat3 && bandar && poskod && negeri) {
