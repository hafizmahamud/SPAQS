...
<div class="pagetitle">
    <h1>Kemaskini Lantikan Penilai</h1>
...
<form id="myForm" autocomplete="off" method="post" novalidate action="{{ url('/awas/savepenilaian') }}"
    ...
    <section class="section">
        <ul style="width: 20%; background: white;" class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                    ...
                    <div class="tab-pane fade show active" id="home-justified" role="tabpanel"
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6">
                                ...
                                <div>
                                    <textarea class="form-control" name="tajuk_perolehan" id="tajuk_perolehan"
                                        value="{{$data->tajuk_perolehan}}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <div class="control-group span6">
                                    <input type="number" min="1" value="{{$dataPenilaian->tempoh_sah_laku}}"
                                        class="form-control" name="tempoh_sah_laku" id="tempoh_sah_laku"
                                        onchange="success()" required />
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <label class="form-label" style="font-weight: bold;">Tarikh Tamat Sah Laku Tender<a
                                        style="color: red;">*</a></label>
                                <div>
                                    <input type="date" class="form-control" id="tarikh_serah_dokumen"
                                        name="tarikh_serah_dokumen"
                                        value="{{ $yeartsdp }}-{{ $monthtsdp }}-{{ $daytsdp }}" onchange="success()"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div>
                                    <select class="form-select" name="penyedia" id="penyedia" onchange="success()"
                                        value="{{ old('penyedia') }}" required>
                                        <option value="">Sila Pilih</option>
                                        @foreach ($getListPenyedia as $penyedia)
                                        <option value="{{ $penyedia->id }}">{{ $penyedia->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
        ...
        <div class="button-form">
            <button class="btn btn-primary" id="open" data-toggle="modal" href="#myModal1" data-backdrop="false"
                style="width: 10%;" onclick="return false;">Hantar</button>
            <button class="btn btn-success" id="draf" name="simpan" type="submit" value="draf" form="myForm"
                style="width: 10%;" onclick="drafpenilaian()">Simpan</button>
            ...
            <div class="container">
                <div class="modal-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <input type="number" min="1" form="myForm" class="form-control" id="no_rujukan"
                                name="no_rujukan" onchange="successmodal()" required>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-2">
                            <input type="number" min="1" form="myForm" class="form-control" id="no_rujukan1"
                                name="no_rujukan1" onchange="successmodal()" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="date" form="myForm" class="form-control" id="tarikh_sah_laku"
                                name="tarikh_sah_laku" onchange="successmodal()" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select id="tempoh_sedia_lt" form="myForm" name="tempoh_sedia_lt" class="form-select"
                                onchange="successmodal()" required>
                                <option value="">Sila Pilih</option>
...
<script>
    var data = @json($dataPenilaian);
    $("#ketua_penilai").val(data.ketua_penilai);
    $("#peg_penilai_1").val(data.pegawai_penilai_1);
    $("#peg_penilai_2").val(data.pegawai_penilai_2);
