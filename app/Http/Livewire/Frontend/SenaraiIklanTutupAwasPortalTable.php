...
class SenaraiIklanTutupAwasPortalTable extends DataTableComponent
{
        ...
        $query = IklanPerolehan::join('mohon_no_perolehan', 'mohon_no_perolehan.id_perolehan', '=', 'iklan_perolehan.mohon_no_perolehan_id')
                ...
                ->where(function ($query) {
                    $query->where('status_iklan_id', 5)
                        ...
                        ->where('matrik_iklan.jenis_iklan_id', '2')
                        ->whereNull('iklan_perolehan.status_kemaskini_penilaian');
                })
    ...
    {
        return 'livewire.frontend.senarai_iklan_tutup_awas_portal';
    }
}