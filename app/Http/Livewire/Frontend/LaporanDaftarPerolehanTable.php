...
use Rappasoft\LaravelLivewireTables\Views\Storage;
use Carbon\Carbon;
 ...
 * @link     https://www.plisca.com.my/
 */
class LaporanDaftarPerolehanTable extends DataTableComponent
{
    ...
    public function query(): Builder
    {
        ...
        $query = PermohonanNomborPerolehan::with('users','section','matrikIklan.jenisIklan','matrikIklan.kategoriPerolehan','negeri','iklanPerolehan.statusIklan')
