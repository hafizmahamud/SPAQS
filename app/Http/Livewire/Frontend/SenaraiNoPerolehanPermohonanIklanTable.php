...
/**
 * SenaraiNoPerolehanPermohonanIklanTable File.
 *
 * PHP Version 8.0
 *
 * @category SenaraiNoPerolehanPermohonanIklanTable
 * @package  SenaraiNoPerolehanPermohonanIklanTable
...
/**
 * Class SenaraiNoPerolehanPermohonanIklanTable.
 *
 * @category SenaraiNoPerolehanPermohonanIklanTable
 * @package  SenaraiNoPerolehanPermohonanIklanTable
 * @author   Aina Zuhairah <aina@plisca.com.my>
 ...
 * @link     https://www.plisca.com.my/
 */
class SenaraiNoPerolehanPermohonanIklanTable extends DataTableComponent
{
    public $user_id;
    ...
    {
        $query = PermohonanNomborPerolehan::with('section', 'matrikIklan.jenisIklan', 'negeri', 'iklanPerolehan')->where('user_id', $this->user_id)->where('status', 'iklan')->orWhere('status', 'selesai');
        return $query
    ...
    {
        return 'livewire.frontend.senarai-no-perolehan-permohonan-iklan-table';
    }
}
