...
class SenaraiIklanTutupAwasTable extends DataTableComponent
{
    ...
    public function query(): Builder
    {
        $query = IklanPerolehan::join('mohon_no_perolehan', 'mohon_no_perolehan.id_perolehan', '=', 'iklan_perolehan.mohon_no_perolehan_id')
                ...
                ->where(function($query) {
                    $query->where('status_iklan_id', 7)->where('matrik_iklan.jenis_iklan_id', '2');
    ...
    {
        return 'livewire.frontend.senarai_iklan_tutup_awas';
    }
}
