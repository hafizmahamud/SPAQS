...
/**
 * SenaraiSuratLanjutan File.
 *
 * PHP Version 8.0
 *
 * @category SenaraiSuratLanjutan
 * @package  SenaraiSuratLanjutan
...
class SenaraiSuratLanjutan extends DataTableComponent
{
    ...
    public function query(): Builder
    {
        $query = IklanPerolehan::join('mohon_no_perolehan', 'mohon_no_perolehan.id_perolehan', '=', 'iklan_perolehan.mohon_no_perolehan_id')
                ...
                ->where(function($query) {
                    $query->where('status_iklan_id', 5)->where('matrik_iklan.jenis_iklan_id', '2')->where('penilaian_perolehan.status_penilaian', 1);
        ...
        return [
            ...
            Column::make(__('No Tender/Projek'))
                ...
                Column::make('Tarikh Kemaskini Penilaian')
                    ->sortable(function(Builder $query, $direction) {
                        return $query->join('mohon_no_perolehan', 'mohon_no_perolehan.id_perolehan', '=', 'penilaian.mohon_no_perolehan_id')
                        ->orderBy(Penilaian::select('tarikh_kemaskini_penilaian')->whereColumn('penilaian.mohon_no_perolehan_id', 'mohon_no_perolehan.id_perolehan'), $direction);
                    }),
    ...
    {
        return 'livewire.frontend.senarai-surat-lanjutan';
    }
}
