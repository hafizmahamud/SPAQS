...
<body>
    ...
    <table>
        <tr>
            ...
            <td class="thirdColumn">PENGARAH<br>BAHAGIAN PENGURUSAN XXX</td>
        </tr>
        ...
        <tr>
            ...
            <td class="secondColumn">:</td>
            <td class="thirdColumn">KEPUTUSAN LEMBAGA PEROLEHAN {!! $kementerian1 !!} BIL.XX/2022</td>
        </tr>
    </table>
    <br>
    <hr>
    <label>Dengan hormatnya perkara di atas adalah dirujuk.</label><br>
    <div>2.	Bersama-sama ini disertakan keputusan Mesyuarat Lembaga Perolehan {!! $kementerian !!} Bil.XX/2022 bagi kertas perolehan berikut:</div>
    <br>
    <b style="font-size: 11px;">DETAILED XXX (JPS/IP/XX/XX/XX/XXXX)</b><br>
