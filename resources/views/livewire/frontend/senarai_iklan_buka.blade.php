<div>
    ...
    <x-livewire-tables::bs4.table.cell style="width:40%">
        <a href="/tunas/viewiklan-public/{{$row->id}}" target="_blank">{{ $row->mohonnoperolehan['no_perolehan'] }}</a>
        <br>
    ...
    {{-- <x-livewire-tables::bs4.table.cell style="width:5%">
        {{ $row->mohonnoperolehan['matrikIklan']['kategoriPerolehan']['nama']}}
    </x-livewire-tables::bs4.table.cell> --}}
