...
<head>
    <title>Surat Akuan Pelantikan</title>
</head>

<body>

    <h3 style="text-align: center; font-family: Arial, Helvetica, sans-serif;">{!! $tajukSAP1 !!}</h3>
    <h3 style="text-align: center; font-family: Arial, Helvetica, sans-serif;">{!! $tajukSAP2 !!}</h3>
    <br />
    <ul>
