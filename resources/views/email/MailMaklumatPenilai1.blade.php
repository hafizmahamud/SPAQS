...
@component('mail::button', ['url' => $dataP1["memo_lantikan"] ])
Memo Lantikan
@endcomponent

@component('mail::button', ['url' => $dataP1["borang_tindakan"] ])
Borang Tindakan
@endcomponent

@component('mail::button', ['url' => $dataP1["surat_akuan_pelantikan"] ])
Surat Akuan Pelantikan
@endcomponent

@component('mail::button', ['url' => $dataP1["surat_akuan_selesai_tugas"] ])
