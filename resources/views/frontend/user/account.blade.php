...
@section('content')
<main id="main-sisdant" class="main" style="margin-bottom: 50px">
    <div class="container">
        <div class="pagetitle" style="margin-top: 50px">
            <h1>Akaun Saya</h1>
            <nav aria-label="breadcrumb" style="margin-top:10px;">
                <ol class="breadcrumb breadcrumb-alt">
                    <li class="breadcrumb-item" style="font-weight: 100; font-size: 16px;"><a href="{{ route('frontend.user.dashboard') }}">Menu Utama</a></li>
                    <li class="breadcrumb-item active" style="color: #1F944A; font-size: 18px !important;">Akaun Saya</li>
                </ol>
            </nav>
        </div>
