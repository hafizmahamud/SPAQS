...
<head>
    ...
    <meta name="author" content="PLISCA">
    <title>SPAQS - LogViewer</title>
    {{-- Styles --}}
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css">
    {{-- <link href={{ url("spaqs/assets/css/font-awesome.min.css") }} rel="stylesheet"> --}}
...
<nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item" style="position: absolute;right: 1%;">
...
<footer class="main-footer">
    <div class="container-fluid">
        <p class="text-muted pull-left">
            SPAQS - SISTEM PENGURUSAN APLIKASI QUANTITY SURVEYING
        </p>
