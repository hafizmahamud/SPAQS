...
@section('content')
    <x-backend.card>
        ...
        <x-slot name="body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <textarea name="text_3" id="text_3" class="form-control" readonly style="height: 70px;">{{ $data->text_3 }}</textarea>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-2 col-form-label">@lang('Isi 2')</label>
                <div class="col-md-10">
                    <textarea name="text_4" id="text_4" class="form-control" readonly style="height: 70px;">{{ $data->text_4 }}</textarea>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <textarea name="text_7" id="text_7" class="form-control" readonly style="height: 60px;">{{ $data->text_7 }}</textarea>
                </div>
            </div>
        </x-slot>
    ...
    <script>
        function view(id) {
            window.location.href="selesaitugas/" + id + "/edit";
        }

        function panduan() {
            Swal.fire({
                width: 600,
                imageUrl: window.location.origin + '/spaqs/assets/img/panduan/akuan_selesai.PNG',
                imageWidth: 600,
                imageHeight: 600,
        ...
        function generate() {
            ...
            window.location.href="/admin/auth/selesaitugas/downloadselesaitugas/" + result;
        }
      </script>
@endsection
