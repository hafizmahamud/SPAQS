...
@section('content')
    <x-forms.post :action="route('admin.auth.akuanpelantikan.update', $data)">
        <x-backend.card>
            <x-slot name="header">
                <span style="font-weight: bold;"> @lang('Isi Kandungan Surat Akuan Pelantikan Ahli Jawatankuasa Penilaian Tender') </span>
            </x-slot>
            <x-slot name="headerActions">
                <x-utils.link class="card-header-action" :href="route('admin.auth.akuanpelantikan.index')" :text="__('Kembali')" />
            </x-slot>
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea name="text_3" id="text_3" class="form-control" required style="height: 50px;">{{ $data->text_3 }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">@lang('Isi 3')<a style="color: red;"> *</a></label>
                    <div class="col-md-10">
                        <textarea name="text_4" id="text_4" class="form-control" required style="height: 80px;">{{ $data->text_4 }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">@lang('Isi 5')<a style="color: red;"> *</a></label>
                    <div class="col-md-10">
                        <textarea name="text_6" id="text_6" class="form-control" required style="height: 60px;">{{ $data->text_6 }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">@lang('Isi 6')<a style="color: red;"> *</a></label>
                    <div class="col-md-10">
                        <textarea name="text_7" id="text_7" class="form-control" required style="height: 60px;">{{ $data->text_7 }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-form-label">@lang('Isi 7 (jika ada)')</label>
                    <div class="col-md-10">
                        <textarea name="text_8" id="text_8" class="form-control" style="height: 60px;">{{ $data->text_8 }}</textarea>
                    </div>
                </div>
