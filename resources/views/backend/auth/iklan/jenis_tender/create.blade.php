...
@section('title', __('Tambah Jenis Perolehan'))

@section('content')
    <x-forms.post :action="route('admin.auth.iklan.simpan_jenis_tender')">
        <x-backend.card>
            <x-slot name="header">
            <span style="font-weight: bold;"> @lang('Tambah Jenis Perolehan') </span>
            </x-slot>
