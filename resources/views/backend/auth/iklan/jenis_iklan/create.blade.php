...
@section('title', __('Tambah Jenis Iklan'))

@section('title', __('Tambah Jenis Iklan'))

@section('content')
    <x-forms.post :action="route('admin.auth.iklan.simpan_jenis_iklan')">
        <x-backend.card>
            <x-slot name="header">
            <span style="font-weight: bold;"> @lang('Tambah Jenis Iklan') </span>
            </x-slot>
